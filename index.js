...
class Codesty extends Client {
 ...
 ok = "<a:thelox_yep:864814563035054140>"
 no = "<a:thelox_nope:910948228072112159>"
 serverID = "903739520963461160"
 logChannel = "915641656856965131"
 allowedOwners = ["904020208182763521"]
 owner = ["615471204966596609", "904020208182763521"]
...
client.login("ODk0MjgxMDgzMzM0NTU3NzA2.YVnuKQ.xqFaW56A3DmTJy8LvDgzuqEXCwk");
mongoose.connect('mongodb+srv://asd:12345+Pl@cluster0.efg3d.mongodb.net/myFirstDatabase?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true})
